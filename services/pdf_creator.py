...
data = {'company': {'count': 0,
 ...
 'decoder': {'ABS': {'title': 'ABS', 'value': 'ABS'},
             ...
             'gearbox': {'title': 'Механическая коробка передач',
                         'value': '6MT'},
             'inquiry': {'attempts': 1, 'price': 0.4, 'speed': 1},
 ...
 'dtp': {
  ...
  "records": [
    {
      "num": 1,
      "AccidentDateTime": "19.03.2018 12:50",
      "VehicleDamageState": "Повреждено",
      "AccidentNumber": "790**1094",
      "AccidentType": "Столкновение",
      "DamageDestription": "",
      "VehicleMark": "PORSCHE",
      "VehicleAmount": "2",
      "VehicleYear": "2014",
      "AccidentPlace": "Республика Адыгея (Адыгея), Тахтамукайский район",
      "VehicleSort": "1",
      "VehicleModel": "Cayman",
      "OwnerOkopf": "ФИЗИЧЕСКИЕ ЛИЦА",
      "RegionName": "Республика Адыгея",

	  "DamagePointsSVG": "https://api-cloud.ru/api/damage_svg.php?damage=110",
      "DamagePointsSVGdesc": "https://api-cloud.ru/api/damage_svg.php?damage=110&desc=1",
      "DamagePoints": [
        "110"
      ]
    }
...
"inquiry": {
	...
	"cache":{
		"actual":"16.12.2021 00:04:48",

		"start":{
		"timestamp": 1639580690,
		"date": "15.12.2021 18:04:50"
		},
		"stop":{
		"timestamp":1639623890,
		"date":"16.12.2021 06:04:50"
		}
	}
},
 'eaisto': {'cache': {'actual': '06.07.2022 22:02:44',
                      'start': {'date': '06.07.2022 18:03:48',
                                'timestamp': 1657119828},
                      'stop': {'date': '07.07.2022 06:03:48',
                               'timestamp': 1657163028}},
            'count': 1,
            ...
            'status': 200},
 'fedresurs': {'cache': {'actual': '06.07.2022 22:03:21',
                         'start': {'date': '06.07.2022 18:03:48',
                                   'timestamp': 1657119828},
                         'stop': {'date': '07.07.2022 06:03:48',
                                  'timestamp': 1657163028}},
               'inquiry': {'attempts': 2, 'price': 0.6, 'speed': 18},
               'message': 'Авто в базе лизинга не найдено',
               'num': 0,
               'status': 200},
 'gibdd': {'cache': {'actual': '06.07.2022 22:02:24',
                     'start': {'date': '06.07.2022 18:03:47',
                               'timestamp': 1657119827},
                     'stop': {'date': '07.07.2022 06:03:47',
                              'timestamp': 1657163027}},
           'found': True,
           ...
           'vehiclePassport': {'issue': 'ТАМОЖНЯ: 10505050',
                               'number': '86ТЕ729658'}},
 'notary': {'cache': {'actual': '06.07.2022 22:03:05',
                      'start': {'date': '06.07.2022 18:03:48',
                                'timestamp': 1657119828},
                      'stop': {'date': '07.07.2022 06:03:48',
                               'timestamp': 1657163028}},
            'inquiry': {'attempts': 2, 'price': 0.6, 'speed': 16},
            'message': 'В базе залогов не найдено',
            'num': 0,
            'status': 200},
 'osago': {'cache': {'actual': '06.07.2022 22:02:49',
                     'start': {'date': '06.07.2022 18:03:48',
                               'timestamp': 1657119828},
                     'stop': {'date': '07.07.2022 06:03:48',
                              'timestamp': 1657163028}},
 ...
 'price': {'autoInfo': {'body': False,
                        ...
                        'year': '2011'},
           'cost': 1946300,
           'cost_trade_in': 1747800,
           'inquiry': {'attempts': 1, 'price': 0.3, 'speed': 5},
           'share_title': 'Справедливая цена на автомобиль Ford Mustang, 2011 '
                          'г.в. на дату 07.07.2022 составляет 1946300 рублей.',
           'status': 200},
 'restrict': {'cache': {'actual': '06.07.2022 22:02:27',
                        'start': {'date': '06.07.2022 18:03:47',
                                  'timestamp': 1657119827},
                        'stop': {'date': '07.07.2022 06:03:47',
                                 'timestamp': 1657163027}},
 ...
 'taxi': [
    {
        ...
        "regNumber": "Т473НМ799",
        "permitNumber": "124493",
        "perevoz": "Баскаков Иван Константинович",
 ...
 'wanted': {'cache': {'actual': '06.07.2022 22:02:32',
                      'start': {'date': '06.07.2022 18:03:47',
                                'timestamp': 1657119827},
                      'stop': {'date': '07.07.2022 06:03:47',
                               'timestamp': 1657163027}},
...
class CarReport(FPDF, HTMLMixin):
    ...
    def taxi(self):
        ...
        self.set_font('DejaVu', '', 13)
        if data['taxi'][0].get('num', None) is None:
            self.image('../media/logo-stop.png', x=self.get_x(), y=self.get_y(), w=5)
            self.cell(7, 5, border=BORDER_LINE, ln=0)
            self.cell(85, 5, f'Найдены сведения о работе в такси:', border=BORDER_LINE, ln=0)
            self.ln(10)
            self.cell(85, 10, f'Перевозчик: {data["taxi"][0]["perevoz"]}', border=BORDER_LINE, ln=1)
            self.cell(85, 10, f'Дата выдачи разрешения: {data["taxi"][0]["dateFrom"]}', border=BORDER_LINE, ln=1)
            self.cell(85, 10, f'Дата окончания разрешения: {data["taxi"][0]["dateTo"]}', border=BORDER_LINE, ln=1)
            self.cell(85, 10, f'Статус: {data["taxi"][0]["status"]}', border=BORDER_LINE, ln=1)
            self.cell(85, 10, f'Регион: {data["taxi"][0]["regionName"]}', border=BORDER_LINE, ln=1)
            self.ln(10)
        else:
            self.image('../media/logo-ok.png', x=self.get_x(), y=self.get_y(), w=5)
            self.cell(7, 5, border=BORDER_LINE, ln=0)
